class DynamicScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Remove the problematic enemy colliders and use overlap detection instead
  ...
  update() {
    ...
    // Manual enemy collision detection (more reliable than Phaser colliders)
  ...
  handleEnemyCollision(player, enemy) {
    ...
    // Set invulnerability immediately to prevent multiple calls
    this.playerState.invulnerable = true;
    this.playerState.invulnerabilityTimer = 120; // 2 seconds of invulnerability at 60fps
    
    // Handle player-enemy collision
    this.playerState.health--;
    
    console.log('Enemy collision! Health:', this.playerState.health);
