    ...
    <div className="h-full flex flex-col bg-gray-900">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-800 border-b border-gray-700">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-semibold text-sm text-white">Game Preview</span>
          {isLoading && (
            <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            disabled={isLoading}
            className="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 disabled:cursor-not-allowed text-gray-300 rounded-md transition-colors text-sm"
          >
      ...
      <div className="px-4 py-2 bg-gray-800 border-t border-gray-700">
        <div className="flex items-center justify-between text-xs text-gray-400">
          <span>Live preview of your Phaser.js game</span>
          <span>Auto-refreshes when files change</span>
        </div>
      </div>
    </div>
  );
